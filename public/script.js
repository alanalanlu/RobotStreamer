...
function countdown(){
  if (timer>=0){
      setTimeout(function(){
        document.getElementById("timer").innerHTML = "Time Left: " + timer.toString()
        timer-=1;
        countdown();
      }, 1000)}
      else{
        document.getElementById("timer").innerHTML = "Thanks for trying my robot!"
      }
}
